...
public class NoticePageVO {
	...
	public void setNowPage(int nowPagee) {
		this.nowPage = nowPagee;
	}
	...
	public String toString() {
		return "NoticePageVO [nowPage=" + nowPage + ", startPage=" + startPage + ", endPage=" + endPage + ", total="
